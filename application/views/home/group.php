        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <div class="breadcrumb-content">
                    <h2><?php 
                        if ($produect_group) {
                            echo $produect_group[0]['group_name']; 
                        }
                        ?></h2>
                </div>
            </div>
            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php if ($produect_group) {
                            echo $produect_group[0]['group_name']; 
                        } ?></li>
                    </ol>
                </nav>
            ...
            <div class="col-12 col-xl-8">
                <div class="about-us-content bg-white mb-30 p-30 box-shadow">
                    ...
                    <div class="section-heading">
                        <h5><?php if ($produect_group) {
                            echo $produect_group[0]['group_name']; 
                        } ?></h5>
                    </div>
                    <!--Carousel Wrapper-->
                    <?php foreach ($produect_group as $key => $value) {?>
