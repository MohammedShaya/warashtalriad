...
<div class="content-wrapper" style="min-height: 946px;">  
    <section class="content-header">
        <h1>
            <i class="fa fa-mortar-board"></i>  <?php echo $this->lang->line('offers'); ?></h1>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('offers', 'can_add')) {
                ?>        
                <div class="col-md-4">          
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_offers'); ?> </h3>
                        </div>
                        <form  action="<?php echo base_url(); ?>offers/add" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">ا<?php echo $this->lang->line('name_offers'); ?></label><small class="req"> *</small>
            ...
            ?>">            
                <div class="box box-primary" id="sublist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> <?php echo $this->lang->line('offers'); ?></h3>
                    </div>
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"> <?php echo $this->lang->line('offers'); ?></div>
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th> <?php echo $this->lang->line('name_offers'); ?></th>
                                        ...
                                        <th> <?php echo $this->lang->line('image_primary'); ?></th>
                                         ...
                                         <?php
                                    if ($this->rbac->hasPrivilege('offers', 'can_edit')||
                                        $this->rbac->hasPrivilege('offers', 'can_delete')) {
                                        ?>
...
<script type="text/javascript">
    ...
    // get_data(page_url);
    let url='<?php echo base_url('offers/load_data'); ?>';
