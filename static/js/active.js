(function ($) {
    ...
    if ($.fn.owlCarousel) {
        ...
        $('.owl-item').on('mouseenter',function(e){
            welcomeSlides.trigger('stop.owl.autoplay');
           })
    
            $('.owl-item').on('mouseleave',function(e){
                welcomeSlides.trigger('play.owl.autoplay', 1000);
            })
      ...
      let item=  $('.sports-videos-slides').owlCarousel({
            items: 2,
            margin: 30,
            loop: true,
            nav: true,
        ...
        $('.group_slider').on('mouseenter',function(e){
            item.trigger('stop.owl.autoplay');
           })
    
            $('.group_slider').on('mouseleave',function(e){
                item.trigger('play.owl.autoplay', 1000);
            })
    }
